...
const Footer = () => {
  ...
  const linkSections = [
    ...
    },
    {
      title: "CONTACT",
      links: [
        { text: "+91 7405722180", path: "/", icon: MailIcon },
        { text: "aadilpar74@gmail.com", path: "/", icon: PhoneIcon },
        { text: "Rajkot Gujarat", path: "/", icon: MapPinIcon },
      ],
    },
  ];
    ...
    <footer className="mx-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          <div>
            ...
            <p className="max-w-[410px] mt-6 text-sm">
              Welcome to thefray, your ultimate destination for the latest and
        ...
        <p className="py-4 text-sm text-slate-500">
          Copyright 2025 © thefray All Right Reserved.
        </p>
      </div>
    </footer>
  );
